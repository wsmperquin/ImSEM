...
<!-- Theme info Area -->
<div class="container <?php if('EnvoPress' == $activate_theme || 'Arvada' == $activate_theme || 'EarnPress' == $activate_theme || 'ConsultZone' == $activate_theme || 'ConsultHub' == $activate_theme || 'ConsultGuide' == $activate_theme){echo 'vrsn-two';}?>" id="theme-info-area">
